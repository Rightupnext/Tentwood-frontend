...
function DestinationCard({ dest, index, visible }) {
  ...
  const originalPrice =
    dest.discount > 0 ? dest.price / (1 - dest.discount / 100) : dest.price;

  return (
    <div
      className={`group bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-700 hover:-translate-y-3 overflow-hidden cursor-pointer transform ${
        visible
          ...
          <div className="flex flex-col">
            {dest.discount > 0 && (
              <span className="text-xs text-gray-400 line-through mb-0.5">
                USD ${Math.round(originalPrice)}
              </span>
            )}
            <div className="text-2xl font-bold text-gray-900">
              USD $ <span className="text-teal-600">{dest.price}</span>
            </div>
          </div>
    ...
    <button
      ...
      className={`flex items-center justify-center gap-1 md:gap-2 px-2 md:px-4 py-2 md:py-3 rounded-xl transition-all duration-300 group border transform hover:scale-105 active:scale-95 shadow-sm hover:shadow-md ${
        active
          ...
          : "bg-white text-gray-700 border-gray-200 hover:bg-teal-50 hover:border-teal-600"
      }`}
    >
      <div
        className={`transition-colors ${
          active ? "text-white" : "text-gray-600 group-hover:text-teal-600"
        }`}
      >
        {icon}
      </div>
...
export default function TravelSearch() {
    ...
    1: [
      {
        ...
        desc: "Experience breathtaking Alpine scenery with pristine lakes and snow-capped mountains.",
        price: 520,
        rating: 4.8,
        discount: 30,
      },
      {
        name: "Berlin",
        image:
          "https://images.pexels.com/photos/2609954/pexels-photo-2609954.jpeg?auto=compress&cs=tinysrgb&w=800",
        desc: "Discover rich history, vibrant culture, and iconic landmarks in Germany's capital.",
        price: 320,
        rating: 5.0,
        discount: 0,
      },
      {
        ...
        desc: "Paradise beaches with crystal clear waters and luxurious overwater bungalows.",
        price: 660,
        rating: 4.5,
        discount: 25,
      },
      {
        ...
        desc: "Urban sophistication meets natural beauty in Canada's largest city.",
        price: 290,
        rating: 4.6,
        discount: 15,
      },
      {
        ...
        desc: "Where ancient history meets modern architecture on the Caspian Sea coast.",
        price: 440,
        rating: 5.0,
        discount: 20,
      },
      {
        ...
        desc: "Ancient wonders, modern marvels, and diverse landscapes await exploration.",
        price: 380,
        rating: 4.9,
        discount: 10,
      },
    ...
    2: [
      {
        ...
        desc: "The City of Light beckons with art, culture, and romantic charm.",
        price: 680,
        rating: 4.9,
        discount: 20,
      },
      {
        ...
        desc: "Ultra-modern metropolis blending tradition with cutting-edge technology.",
        price: 780,
        rating: 4.8,
        discount: 15,
      },
      ...
      },
      {
        ...
        desc: "The city that never sleeps offers endless entertainment and culture.",
        price: 720,
        rating: 4.9,
        discount: 10,
      },
      {
        ...
        desc: "Gaudí's masterpieces, Mediterranean beaches, and vibrant nightlife.",
        price: 450,
        rating: 4.8,
        discount: 30,
      },
      {
        ...
        desc: "Land of fire and ice with spectacular waterfalls and northern lights.",
        price: 850,
        rating: 5.0,
        discount: 0,
      },
    ...
    3: [
      {
        ...
        desc: "White-washed buildings and stunning sunsets over the Aegean Sea.",
        price: 620,
        rating: 4.9,
        discount: 20,
      },
      {
        ...
        desc: "Tropical paradise with ancient temples, rice terraces, and beaches.",
        price: 480,
        rating: 4.7,
        discount: 25,
      },
      {
        name: "Amsterdam",
        image:
          "https://images.pexels.com/photos/2031706/pexels-photo-2031706.jpeg?auto=compress&cs=tinysrgb&w=800",
        desc: "Charming canals, world-class museums, and cycling culture.",
        price: 540,
        rating: 4.8,
        discount: 15,
      },
      {
        ...
        desc: "Medieval architecture and fairy-tale charm in the heart of Europe.",
        price: 380,
        rating: 4.9,
        discount: 30,
      },
      {
        ...
        desc: "Iconic Opera House, stunning harbor, and beautiful beaches.",
        price: 890,
        rating: 4.8,
        discount: 10,
      },
      {
        ...
        desc: "Futuristic city-state with incredible food and attractions.",
        price: 670,
        rating: 4.9,
        discount: 20,
      },
    ...
    4: [
      {
        ...
        desc: "Romantic canals, historic palaces, and timeless Italian charm.",
        price: 580,
        rating: 4.8,
        discount: 25,
      },
      {
        ...
        desc: "Tropical beaches, ornate temples, and delicious street food.",
        price: 420,
        rating: 4.7,
        discount: 30,
      },
      {
        ...
        image:
          "https://images.pexels.com/photos/2422497/pexels-photo-2422497.jpeg?auto=compress&cs=tinysrgb&w=800",
        desc: "Majestic fjords, midnight sun, and Viking heritage.",
        price: 920,
        rating: 5.0,
        discount: 0,
      },
      {
        ...
        desc: "Ancient ruins, Renaissance art, and authentic Italian cuisine.",
        price: 560,
        rating: 4.9,
        discount: 15,
      },
      {
        ...
        desc: "K-pop culture, futuristic tech, and traditional palaces.",
        price: 650,
        rating: 4.8,
        discount: 20,
      },
      {
        name: "Morocco",
        image:
          "https://images.pexels.com/photos/2079665/pexels-photo-2079665.jpeg?auto=compress&cs=tinysrgb&w=800",
        desc: "Exotic markets, desert landscapes, and vibrant culture.",
        price: 490,
        rating: 4.7,
        discount: 25,
      },
    ...
    5: [
      {
        ...
        desc: "Historic landmarks, royal palaces, and world-class museums.",
        price: 740,
        rating: 4.9,
        discount: 15,
      },
      {
        ...
        desc: "Stunning landscapes from mountains to beaches and everything between.",
        price: 980,
        rating: 5.0,
        discount: 10,
      },
      {
        name: "Peru",
        image:
          "https://images.pexels.com/photos/2049194/pexels-photo-2049194.jpeg?auto=compress&cs=tinysrgb&w=800",
        desc: "Ancient Incan ruins, Amazon rainforest, and colorful traditions.",
        price: 520,
        rating: 4.8,
        discount: 20,
      },
      {
        name: "Austria",
        image:
          "https://images.pexels.com/photos/2467598/pexels-photo-2467598.jpeg?auto=compress&cs=tinysrgb&w=800",
        desc: "Alpine beauty, classical music heritage, and imperial architecture.",
        price: 610,
        rating: 4.8,
        discount: 25,
      },
      {
        ...
        desc: "Adriatic coastline, medieval towns, and crystal-clear waters.",
        price: 440,
        rating: 4.7,
        discount: 30,
      },
      {
        ...
        desc: "Highland landscapes, historic castles, and whisky trails.",
        price: 580,
        rating: 4.9,
        discount: 20,
      },
  ...
  const getFilteredAndSortedDestinations = () => {
    let filtered = (allDestinations[currentPage] || allDestinations[1]).filter(
      (dest) => {
        const matchesSearch =
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      <audio ref={audioRef} loop preload="auto" crossOrigin="anonymous">
        <source
          src="https://res.cloudinary.com/dttvw0p7p/video/upload/v1765865228/Untitled_design_xpdwp2.mp4"
          type="audio/mpeg"
        />
      </audio>
      ...
      <div className="relative h-[400px] md:h-[600px] lg:h-[700px] overflow-hidden">
        ...
        >
          {isMuted ? (
            ...
            <SoundOutlined style={{ fontSize: 20 }} className="text-teal-600" />
          )}
        </button>
        ...
        >
          <div className="text-xs md:text-sm text-white/90 mb-3 tracking-[0.3em] font-medium uppercase">
            Search Tour
          </div>
          <h1
            className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-4 md:mb-8 italic drop-shadow-2xl leading-tight"
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 md:py-16 -mt-6 md:-mt-12">
        <div className="grid lg:grid-cols-3 gap-6 md:gap-8">
          <div className="lg:col-span-2 space-y-6 md:space-y-8">
            <div className="relative w-full shadow-lg rounded-2xl bg-white p-4">
              ...
              <input
                ...
                className="w-full pl-14 pr-4 py-3 bg-white text-base border-2 border-gray-100 rounded-xl focus:border-teal-600 focus:ring-4 focus:ring-teal-600/20 outline-none transition-all"
              />
            </div>
            ...
            <div className="flex items-center justify-center gap-2 md:gap-3 mt-8">
              <button
                ...
                className={`w-10 h-10 md:w-11 md:h-11 rounded-full bg-white shadow-md transition-all flex items-center justify-center border border-gray-200 ${
                  currentPage === 1
                    ? "opacity-50 cursor-not-allowed"
                    : "hover:shadow-lg hover:scale-110 hover:bg-teal-600 hover:text-white"
                }`}
              >
              ...
              {[1, 2, 3, 4, 5].map((num) => (
                <button
                  ...
                  className={`w-10 h-10 md:w-11 md:h-11 rounded-full font-bold text-sm md:text-base transition-all duration-300 transform ${
                    num === currentPage
                      ? "bg-gradient-to-r from-teal-600 to-teal-700 text-white shadow-lg scale-110"
                      : "bg-white text-gray-700 shadow-md hover:bg-teal-50 hover:scale-105 hover:shadow-lg"
                  }`}
                >
                  {num}
                </button>
          ...
          <div className="space-y-6">
            <div
              className={`bg-white rounded-3xl shadow-xl p-6 md:p-8 transition-all duration-1000 hover:shadow-2xl transform ${
                visible
            ...
            >
              ...
              <p className="text-gray-600 text-sm mb-6 pb-6 border-b border-gray-100">
                Discover amazing destinations around the world. Filter by price
                and find your perfect getaway today.
              </p>
              <div className="space-y-4 mb-6">
                <input
                  type="text"
                  placeholder="Where To?"
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-teal-600 focus:ring-4 focus:ring-teal-600/20 outline-none transition-all placeholder:text-gray-500"
                />
                <input
                  type="text"
                  placeholder="Month"
              ...
              <div className="mb-6">
                ...
                <div className="relative mb-4">
                  <input
                    ...
                    style={{
                      background: `linear-gradient(to right, #0d9488 0%, #0d9488 ${rangePercentage}%, #e5e7eb ${rangePercentage}%, #e5e7eb 100%)`,
                    }}
                  />
                </div>
              ...
              <button className="w-full py-3 md:py-4 bg-gradient-to-r from-teal-600 to-teal-700 text-white font-bold text-sm md:text-base rounded-xl hover:shadow-xl shadow-teal-600/40 transform hover:scale-105 active:scale-100 transition-all duration-300">
                Book Now
              </button>
            </div>

            <div
              className={`relative rounded-3xl shadow-xl overflow-hidden transition-all duration-1000 ${
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex items-end p-6">
                <div className="text-white">
                  ...
                  <p className="text-sm md:text-base text-white/90">
                    Up to 40% off on selected destinations
                  </p>
                </div>
              </div>
            </div>
