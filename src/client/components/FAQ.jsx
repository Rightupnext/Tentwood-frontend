...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Yes! We specialize in creating personalized travel packages tailored to your preferences, budget, and interests. Whether it's adventure, luxury, or cultural tours, we craft unique experiences just for you.",
    },
    {
      question: "Can I Book Flights, Hotels, and Tours Separately?",
      answer:
        "Absolutely! You have the flexibility to book flights, hotels, and tours individually or as a complete package. We provide both options to suit your travel planning needs.",
    },
    {
      question: "Do You Provide Visa Assistance?",
      answer:
        "Yes, we offer comprehensive visa assistance services including document preparation, application submission, and guidance throughout the entire visa process for your destination.",
    },
    {
      question: "What Payment Methods Do You Accept?",
      answer:
        "We accept multiple payment methods including credit/debit cards, bank transfers, digital wallets, and online payment gateways. Flexible payment plans are also available for larger bookings.",
    },
    {
      question: "What Travel Documents are Required for International Travel?",
      answer:
        "For international travel, you'll typically need a valid passport (with at least 6 months validity), visa (if required), travel insurance, flight tickets, hotel confirmations, and any health certificates or vaccination records as per destination requirements.",
    },
  ];
      ...
      <div className="max-w-5xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="space-y-3 md:space-y-4">
          {faqs.map((faq, i) => (
            <div
              key={i}
              className={`bg-white rounded-xl md:rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 overflow-hidden ${
                isVisible
            ...
            >
              ...
              >
                ...
                <div
                  className={`flex-shrink-0 w-6 h-6 md:w-7 md:h-7 flex items-center justify-center transition-all duration-300 ${
