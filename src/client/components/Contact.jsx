    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50 to-blue-50 py-12 px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className={`text-center mb-12 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-8"}`}>
          <p className="text-sm text-gray-600 mb-2 tracking-wider uppercase animate-fade-in">Contact US / Home Contact</p>
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl p-6 md:p-8 border border-white/50 hover:shadow-[#3CAD9B]/20 hover:shadow-3xl transition-all duration-500">
              ...
              <div className="space-y-5">
                {formFields.map((field, idx) => (
                  <div key={field.name} className="group" style={{ animationDelay: `${idx * 100}ms` }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {contactCards.map((c, i) => (
            <div 
              key={i} 
              className={`group relative bg-white/90 backdrop-blur-lg rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-[#3CAD9B]/50 overflow-hidden ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`} 
            ...
            >
              ...
              <div className="relative z-10">
                <div className={`w-16 h-16 bg-gradient-to-br ${c.gradient} rounded-2xl flex items-center justify-center mb-5 shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}>
                  {c.icon}
                </div>
