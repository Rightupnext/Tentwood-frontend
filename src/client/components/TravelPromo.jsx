...
import nature from "../../assets/travel/travel1.jpg";
import cities from "../../assets/travel/travel2.jpg";
import promo1 from "../../assets/travel/promo1.jpg";
import promo2 from "../../assets/travel/promo2.jpg";
import promo3 from "../../assets/travel/promo3.jpg";
  ...
  const Hero = ({ img, title, side }) => {
    ...
    return (
      <div className="relative h-[400px] sm:h-full overflow-hidden group cursor-pointer">
          ...
          >
            ...
            <button className="group/btn relative px-8 sm:px-10 py-3.5 sm:py-4 bg-white/10 backdrop-blur-xl border-2 border-white/60 rounded-full font-bold transition-all duration-500 hover:bg-white hover:text-gray-900 hover:border-white hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] hover:scale-110 overflow-hidden">
              ...
              <span className="relative cursor-pointer z-10 flex items-center gap-3 text-sm sm:text-base tracking-wide">
                View Packages
                <RightOutlined className="w-5 h-5 transition-all duration-500 group-hover/btn:translate-x-2 group-hover/btn:scale-125" />
              </span>
            </button>
          </div>
        </div>
        ...
        <CompassOutlined
          className="!absolute !top-6 text-7xl !text-white !sm:top-10 !right-6 !sm:right-10 !w-16 !sm:w-24 !h-16 !sm:h-24 !opacity-20 !group-hover:opacity-50 !transition-all !duration-700 !group-hover:scale-110"
          style={{
            animation:
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50 p-4 sm:p-8 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 h-auto md:h-[550px] rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden shadow-[0_25px_80px_rgba(0,0,0,0.25)] mb-10 border border-white/20 backdrop-blur-sm">
          <Hero img={nature} title="Nature" side="left" />
          <Hero img={cities} title="Cities" side="right" />
        </div>
